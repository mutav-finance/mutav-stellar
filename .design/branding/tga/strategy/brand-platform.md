...
## 2. Vision (O Futuro Que Construímos)

Um mercado de garantias locatícias no Brasil onde o proprietário nunca espera por um pagamento que já é seu direito, e onde qualquer investidor com acesso à Solana pode participar do yield do mercado imobiliário brasileiro com total transparência sobre o ativo subjacente.
...
A missão une os três produtos: **construir a infraestrutura que faz Lucas receber, Ana investir e o protocolo operar — com a mesma confiança que um mecanismo verificável produz.**
...
Nenhuma promessa é feita sem mecanismo. Antes de comunicar qualquer SLA, capacidade ou resultado, o protocolo deve ser capaz de executá-lo de forma verificável. Copy de marketing não pode existir sem um registro onchain que a suporte.
...
- O código dos smart contracts é auditado e o relatório é vinculado em posição prominente, não em rodapé
- O log de inadimplências e repasses é acessível como dado bruto, não apenas como número agregado no marketing

**Não é:** Radical transparency ao ponto de expor dados operacionais sensíveis ou informações de terceiros. É verificabilidade sobre as claims que a marca faz.
...
- Métricas de desempenho são publicadas com contexto (N de contratos, período de referência, outliers excluídos ou incluídos com justificativa)
- Os fundadores são nomeados, suas credenciais são listadas, e sua identidade é verificável

**Não é:** Rigidez que impede comunicação sob incerteza. Quando há incerteza, a marca a nomeia: "ainda não temos histórico suficiente para publicar SLA — aqui está o que temos até agora."
...
- O dashboard informa proativamente — o proprietário não consulta para descobrir o status, o sistema entrega
- A marca não interrompe a rotina do usuário exceto para entregar informação que ele precisaria de qualquer forma

**Não é:** Passividade de marca ou ausência de comunicação. É a escolha de quando comunicar: quando há algo a dizer, não quando há algo a promover.
...
- Changelog público de atualizações de protocolo com responsável identificado e rationale
- Relatórios de risco assinados — não documentos genéricos sem autoria
- Comunicação de incidentes com nome e data, não com nota de imprensa corporativa sem rosto

**Não é:** Centralização de decisões no fundador ou ruptura com a governança de protocolo. É a recusa de esconder a equipe atrás da infraestrutura técnica.

---

## 5. Promise (O Que Prometemos)

### 5.1 Promessa do Sistema (Unificada — Válida para Ambas as Frentes)

> **O protocolo que cumpre o que promete.**

Esta não é uma promessa de marca no sentido publicitário. É a descrição operacional do produto. O protocolo cumpre porque foi arquitetado para cumprir — não porque a equipe é responsável, não porque os termos são claros, mas porque o mecanismo não tem outra opção senão executar quando as condições são satisfeitas.

### 5.2 Promessa da Dashboard Imobiliárias (Para Lucas)

> **Quando o inquilino para de pagar, você recebe. O protocolo executa. Você não precisa fazer nada.**

Esta promessa tem três componentes funcionais:
1. Gatilho claro: inadimplência do inquilino
2. Resultado claro: repasse ao proprietário
3. Ausência de ação requerida: zero formulário, zero fila, zero intermediário discricionário

O que Lucas compra não é um seguro. É a ausência de um problema que ele já teve antes.

### 5.3 Promessa da Dashboard Investidor (Para Ana)

> **Yield real do mercado imobiliário brasileiro — verificável onchain, específico, auditável. Não mais um pool genérico.**

Esta promessa tem três componentes funcionais:
1. Especificidade do colateral: mercado imobiliário brasileiro (não Treasury, não genérico)
2. Verificabilidade: onchain, em tempo real, por qualquer parte
3. Diferenciação de categoria: não é mais um RWA — é o único com esta especificidade neste mercado

O que Ana compra não é yield. É a primeira exposição ao spread de garantia locatícia brasileira com arquitetura auditável.
